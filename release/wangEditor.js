...
UploadVideo.prototype = {
    ...
    insertLinkVideo: function insertLinkVideo(link) {
        ...
        editor.cmd.do('insertHTML', '<video controls="controls" src="' + link + '" style="max-width:100%;"/>');
    ...
    uploadVideo: function uploadVideo(files) {
        ...
        var editor = this.editor;
        var config = editor.config;
        var uploadVideoServer = editor.config.uploadVideoServer;//上传地址
        ...
        var timeout = 5 * 60 * 100000000;        //5 min
        ...
        var name = videoFile.name || uploadFileName;
        ...
        formdata.append(uploadFileName, videoFile);
        ...
        if (uploadVideoServer && typeof uploadVideoServer === 'string') {
            ...
            xhr.onreadystatechange = function () {
                var result = void 0;
                if (xhr.readyState === 4) {
                    if (xhr.status < 200 || xhr.status >= 300) {                        // hook - error
                    ...
                    // } else {
                        _this3.insertLinkVideo(result.data);
...
Video.prototype = {
    ...
    _createPanel: function _createPanel() {
        ...
        var config = editor.config;
        var Upload = new UploadVideo(editor);
